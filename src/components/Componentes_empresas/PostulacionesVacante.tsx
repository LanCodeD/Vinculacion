...
export default function PostulacionesVacante({ idOferta, usuarioEmpresaId }: Props) {
    ...
    async function actualizarEstado(idPostulacion: number, accion: "aprobar" | "rechazar" | "revisar") {
        try {
    ...
    if (postulaciones.length === 0) return <p className="p-6">No hay postulaciones para esta vacante.</p>;
                        ...
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                            <div>
                                ...
                                <p className="text-sm mt-1 text-blue-600">
                                    Estado: <span className="font-semibold">{p.estado.nombre_estado}</span>
                                </p>
                            </div>
                            ...
                            <div className="flex gap-2 mt-3 md:mt-0">
                                <button
                                    ...
                                    onClick={() => actualizarEstado(p.id_postulaciones, "revisar")}
                                ...
                                <button
                                    disabled={updating === p.id_postulaciones}
                                    onClick={() => actualizarEstado(p.id_postulaciones, "aprobar")}
                                ...
                                <button
                                    disabled={updating === p.id_postulaciones}
                                    onClick={() => actualizarEstado(p.id_postulaciones, "rechazar")}
