// /lib/PlantillasCorreos/resultadoRevisionEspecifico.ts
import { plantillaCorreoBase } from "./plantillaCorreoBase";

export function plantillaResultadoRevisionEspecifico({
  usuarioNombre,
  idSolicitud,
  fueRechazada,
  botonUrl,
  ...
  return plantillaCorreoBase({
    titulo: fueRechazada
      ? " Correcciones necesarias en tu solicitud de Convenio Específico"
    ...
    mensaje: `
      <div style="font-family:Arial, sans-serif; color:#333; line-height:1.6;">
        ...
        <p style="font-size:14px; margin-bottom:10px;">
          Tu solicitud de Convenio Específico 
