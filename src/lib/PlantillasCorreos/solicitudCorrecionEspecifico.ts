// /lib/PlantillasCorreos/solicitudCorreccionEspecifico.ts
import { plantillaCorreoBase } from "./plantillaCorreoBase";

export function plantillaSolicitudCorreccionEspecifico({
  adminNombre,
  usuarioNombre,
  idSolicitud,
  fechaEnvio,
  ...
  return plantillaCorreoBase({
    titulo: "Solicitud de Convenio Específico corregida",
    mensaje: `
      <div style="font-family:Arial, sans-serif; color:#333; line-height:1.6;">
        <p style="font-size:15px;">Hola <strong>${adminNombre}</strong>,</p>
        
        <p style="font-size:14px; margin-bottom:10px;">
          El usuario <strong>${usuarioNombre}</strong> ha corregido la solicitud de Convenio Específico
    ...
    `,
    botonTexto: "Revisar corrección específica",
    botonUrl,
  });
}
